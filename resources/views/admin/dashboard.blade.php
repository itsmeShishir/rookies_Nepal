    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                @if ($role == 'vendor')
                    <h1>Rookies  Vendor Dashboard</h1>
                    <small>Vendor : {{ Auth::user()->name }}</small>
                @else<h1>Rookies Admin Dashboard</h1>
                    <small>Spreading trust and genuine products</small>
                @endif
                    ...
                    <div id="cardbox1">
                        <div class="statistic-box">
                            ...
                            <div class="counter-number pull-right">
                                <span class="count-number">{{ $totalClient }}</span>
                                <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                                </span>
                            </div>
                            <a href="/admin/registered-users" style="color:white;">  <h3> Active Client</h3></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div id="cardbox2">
                        <div class="statistic-box">
                            ...
                            <div class="counter-number pull-right">
                                <span class="count-number">{{ $totalVendors }}</span>
                                <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                                </span>
                            </div>
                            <a href="/admin/vendors" style="color:white;">     <h3> Active Vendors</h3></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div id="cardbox3">
                        <div class="statistic-box">
                            ...
                            <div class="counter-number pull-right">
                                ...
                                <span class="count-number">{{ $totalOrders }}</span>
                                <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                                </span>
                            </div>
                            <a href="/admin/orders" style="color:white;">        <h3> Total Orders</h3></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div id="cardbox4">
                        <div class="statistic-box">
                            ...
                            <div class="counter-number pull-right">
                                <span class="count-number">{{ $totalProductsSold }}</span>
                                <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                                </span>
                            </div>
                            <h3> Products Sold</h3>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div id="cardbox1">
                        <div class="statistic-box">
                            ...
                            <div class="counter-number pull-right">
                                <span class="count-number">{{ $totalFeedbacks }}</span>
                                <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                                </span>
                            </div>
                            <a href="/admin/feedbacks" style="color:white;"><h3> Total Feedbacks</h3></a>
                        </div>
                    </div>
                </div>
                @endif
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div id="cardbox2">
                        <div class="statistic-box">
                            ...
                            <a href="  /admin/view-coupons" style="color:white;"> <h3> Active Coupons</h3></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div id="cardbox3">
                        <div class="statistic-box">
                            <i class="fa fa-money fa-3x"></i>
                            <div class="counter-number pull-right">
                                <i class="ti ti-money"></i><span class="count-number">{{ $totalOrders }}</span>
                                <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                                </span>
                            </div>
                            <a href="/admin/banners" style="color:white;"><h3> Active Ads</h3></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
