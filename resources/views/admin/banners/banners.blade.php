                                    ...
                                    <tbody>
                                        @foreach ($bannerDetails as $ban)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $ban->text_style }}</td>
                                                <td>{{ $ban->link }}</td>
                                                <td>{{ $ban->content }}</td>
                                                <td>
                                                    @if (!empty($ban->image))
                                                        <img src="{{ asset('/uploads/banners/' . $ban->image) }}" alt=""
                                                            style="width:100px">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="BannerStatus btn btn-success"
                                                        rel="{{ $ban->id }}" data-toggle="toggle" data-on="Enabled"
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/edit-banner/' . $ban->id) }}"
                                                class="btn btn-add btn-sm"><i class="fa fa-pencil"></i></a>
                                            <a href="{{ url('/admin/delete-banner/' . $ban->id) }}"
