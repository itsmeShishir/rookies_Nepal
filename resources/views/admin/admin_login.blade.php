...
<head>
        ...
        <title>Rookies Admin/Vendor</title>
    ...
    <body>
        ...
        <div class="login-wrapper">
            <div class="back-link">
                <a href="/" class="btn btn-add">Back to Rookies Nepal </a>
            </div>
            ...
            <div class="logo" style="margin-left: 86px;">
                ...
                <div class="panel panel-bd panel-custom">
                    ...
                    <div class="panel-body">
                        <form action="{{url('/rookiesadmin')}}" id="loginForm" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div>
                                ...
                                <a class="btn btn-warning" href="/vendor/register">Register</a>
                            </div>
                        </form>
                        </div>
                        </div>
